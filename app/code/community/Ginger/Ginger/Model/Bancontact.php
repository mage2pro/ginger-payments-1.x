 ...
 *
 **/
class Ginger_Ginger_Model_Bancontact extends Mage_Payment_Model_Method_Abstract
{
    /**
     * Bancontact settings for Magento
     */
    protected $_bancontact;
    protected $_code = "ginger_bancontact";
    protected $_formBlockType = 'ginger/payment_bancontact_form';
    protected $_infoBlockType = 'ginger/payment_bancontact_info';
