 ...
 *
 **/
class Ginger_Ginger_Model_Sofort extends Mage_Payment_Model_Method_Abstract
{
    /**
     * SOFORT settings for Magento
     */
    protected $_sofort;
    protected $_code = "ginger_sofort";
    protected $_formBlockType = 'ginger/payment_sofort_form';
    protected $_infoBlockType = 'ginger/payment_sofort_info';
