 ...
 *
 **/
class Ginger_Ginger_Helper_Ideal
{
    ...
    /**
     * Ginger_Ginger_Helper_Ideal constructor.
     */
    ...
    {
        return $this->gingerLib->getIdealIssuers()->toArray();
    }
     ...
     * @return bool
     */
    public function createOrder($order_id, $issuer_id, $amount, $currency, $description, $return_url, array $customer)
    {
        if (!$this->setOrderId($order_id)
            || !$this->setIssuerId($issuer_id)
        ...
        $order = $this->gingerLib->createIdealOrder(
